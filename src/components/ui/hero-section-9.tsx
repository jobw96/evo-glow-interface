                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Push Your Limits with AI Precision</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl text-muted-foreground">Train smarter with real-time feedback, AI-driven insights, and precision tracking that adapts to your goals.</p>

                            <Button
                                onClick={() => scrollToSection('#waitlist')}
                                size="lg">
                                <span className="btn-label">Join waitlist now</span>
                            </Button>
                        </div>
                    </div>
                            ...
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=2880&h=2074&fit=crop"
                                        alt="EvoTrack dashboard"
                                        width={2880}
                                        height={2074}
                                    />
                                </div>
...
export const Logo = ({ className }: { className?: string }) => {
    return (
        <div className={cn('text-2xl font-bold text-navy', className)}>
            EvoTrack
        </div>
    )
}
