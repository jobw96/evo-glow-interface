...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="Athlete with fitness tracker" className="w-full h-full object-cover" />
      ...
      <div ref={contentRef} className="scroll-reveal relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <Button onClick={scrollToWaitlist} size="lg" className="neuro-button text-lg px-8 py-6 bg-lime-500 hover:bg-lime-400 text-zinc-950">
          Join waitlist now
        </Button>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 animate-bounce">
        <div className="w-6 h-10 border-2 border-white/30 rounded-full flex items-start justify-center p-2 bg-black/0">
